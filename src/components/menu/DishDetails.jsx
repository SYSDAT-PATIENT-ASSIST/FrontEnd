  ...
  return (
    <div className='text-gray-800'>
      ...
      <div className='bg-gray-50 p-4 rounded-lg mb-4'>
        <h4 className='font-bold mb-3 text-gray-800'>Ernæringsinfo</h4>
        <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
          ...
          <div>
            ...
            <p className='font-medium text-gray-800'>{item.nutrition.fat} g</p>
          </div>
        </div>

        <h5 className='font-medium mt-4 mb-2 text-gray-800'>Allergener</h5>
      ...
      <div className='mb-4'>
        <h4 className='font-bold mb-3 text-gray-800'>Ingredienser</h4>
      ...
      <div className='mb-4'>
        <h4 className='font-bold mb-3 text-gray-800'>Opskrift</h4>
